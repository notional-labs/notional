...
export interface GenesisState {
  ...
  bitcannaidCount: number
  supplychainList: Supplychain[]
  /** this line is used by starport scaffolding # genesis/proto/state */
  supplychainCount: number
}

const baseGenesisState: object = { bitcannaidCount: 0, supplychainCount: 0 }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          message.bitcannaidCount = longToNumber(reader.uint64() as Long)
          break
        case 3:
          message.supplychainList.push(Supplychain.decode(reader, reader.uint32()))
          break
        case 4:
          message.supplychainCount = longToNumber(reader.uint64() as Long)
          break
        default:
